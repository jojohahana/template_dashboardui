<template>
  <div>
    <!-- Start Summary Cards  -->
    <div class="grid grid-cols-1 gap-4 px-4 mt-8 mb-8 sm:grid-cols-4 sm:px-8">
      <StatCard
    ...
    <div class="grid grid-cols-1 gap-4 px-4 mb-8 md:grid-cols-2 lg:grid-cols-3">
      <div class="card">
        <LineChart />
      </div>
      <div class="card">
    ...
    <div class="grid grid-cols-1 gap-4 px-4 md:grid-cols-2 lg:grid-cols-2">
      <div class="card">
        <DoughnutChart />
      </div>
      <div class="card">
